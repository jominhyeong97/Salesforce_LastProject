...
export default class PhoneLeadIntake extends NavigationMixin(LightningElement) {
    memo = '';
    form = { ...EMPTY_FORM };
    extractedFlags = {}; // {fieldKey: true} — AI가 채운 필드 트래킹
    extracting = false;
    saving = false;
    extractError = '';
    saveError = '';
